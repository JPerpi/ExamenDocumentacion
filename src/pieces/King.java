...
public class King extends Piece{
	...
	private int x,y; // Variables extra para mantener un seguimiento de la posición del rey
	

        /**
         * Contructor de la clase Rey
         * @param i Nombre corto del rey
         * @param p Nombre largo del rey
         * @param c color del rey
         * @param x Coordenada X de l pieza
	...
	//Getters y setter para acceder a las variables
	...
	{
                //  El rey solo se puede mover a una casilla que este al lado de la casilla donde se encuentra.
		possiblemoves.clear();
        ...
        /**
         * Funcion para comprobar si el rey esta en jaque por una pieza del color contrario al rey
         * @param state vector de casillas
         * @return True si está en jaque y false si no lo está
         */
	public boolean isindanger(Cell state[][])
    {
		

                // Comprobación para saber por donde lo estan amenzando(arriba, bajao, derecha o izquierda)
    	for(int i=x+1;i<8;i++)
    	{
    	...
    	//// Comprobación para saber por donde lo estan amenzando(diagonales)
		...
		while(tempx<8&&tempy<8)
		{
			...
			else
			{
                ...
                //Comprobación de que el ataque es de una pieza del color contrario
		...
		//Comprobación de posible ataque del peón enemigo
